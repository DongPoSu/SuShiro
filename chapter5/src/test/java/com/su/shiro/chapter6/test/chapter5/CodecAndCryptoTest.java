...
public class CodecAndCryptoTest {
    private static final Logger log = LoggerFactory.getLogger(CodecAndCryptoTest.class);

    @Test
    public void decode() {
        byte[] bytes = Base64.decode("PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==");
    ...
    @Test
    public void testAesChiperService() {
